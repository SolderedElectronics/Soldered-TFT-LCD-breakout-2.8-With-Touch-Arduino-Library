...
#include "libs/Adafruit_GFX_SR/Adafruit_GFX_SR.h"
#include "Arduino.h"
#include "Print.h"
#include "libs/Adafruit_GFX_SR/Adafruit_SPITFT_SR.h"
#include <SPI.h>
...
public:
  Adafruit_ILI9341(SPIClass *spiClass, int8_t cs, int8_t dc, int8_t wr, int8_t rd, int8_t rst);
